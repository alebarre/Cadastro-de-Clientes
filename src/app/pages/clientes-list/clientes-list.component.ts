  ...
  <div class="container-xxl py-3">
    <div class="card shadow-sm">
      <div class="card-header bg-light">
        <strong class="d-block text-truncate" style="font-size: 1.5rem;">Professor, {{ getNameOfTheUser() }}!</strong>
        <h6>Gerencie seus alunos.</h6>
      </div>
    </div>
...
export class ClientesListComponent {
  ...
  getNameOfTheUser(): string {
    return this.auth.getNameOfTheUser();
  }
